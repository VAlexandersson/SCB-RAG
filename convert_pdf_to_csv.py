...
def convert_single_pdf(
    ...
    #page_texts = []
    #for page in pages:
    #    page_text = get_full_text(merge_lines(merge_spans(page.blocks)))
    #    page_text = cleanup_text(page_text)
    #    page_text = replace_bullets(page_text)
    ...
    for merged_line in merged_lines:
      text_blocks = merge_lines([merged_line])
      text_blocks = filter_common_titles(text_blocks)
      full_text = get_full_text(text_blocks)
      full_text = cleanup_text(full_text)
      full_text = replace_bullets(full_text)
    ...
    return all_pages, full_text, doc_images, out_meta